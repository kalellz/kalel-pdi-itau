      ...
      <main className="relative z-10 flex flex-col w-full p-4 pt-32 md:pt-24 md:p-8">
        <div className="flex items-center justify-center w-full">
          ...
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-base sm:text-lg text-zinc-600 dark:text-zinc-400">Trajetória e metas profissionais</p>
          </div>
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-6 md:p-8 shadow-lg">
            ...
            <p className="text-base md:text-lg text-blue-600 dark:text-blue-400 font-semibold mb-6">
              ANL ENGENHARIA TI
            </p>
            <div className="space-y-3 md:space-y-4">
              {careerPath.map((item, index) => (
                <div key={index} className="flex items-start md:items-center gap-3 md:gap-4">
            ...
            <div className="mt-8 md:mt-12 pt-6 md:pt-8 border-t border-zinc-200 dark:border-zinc-800">
              ...
              <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-4">
                <div className="p-3 md:p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                  <p className="text-xs text-zinc-600 dark:text-zinc-400 mb-1">Estagiário</p>
                  <p className="font-bold text-zinc-900 dark:text-white text-sm">Frontend</p>
                </div>
                
                <div className="p-3 md:p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
                  <p className="text-xs text-zinc-600 dark:text-zinc-400 mb-1">Júnior</p>
                  <p className="font-bold text-zinc-900 dark:text-white text-sm">Backend/Infra</p>
                </div>
                
                <div className="p-3 md:p-4 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg border border-indigo-200 dark:border-indigo-800">
                  <p className="text-xs text-zinc-600 dark:text-zinc-400 mb-1">Pleno</p>
                  <p className="font-bold text-zinc-900 dark:text-white text-sm">Fullstack</p>
                </div>
                
                <div className="p-3 md:p-4 bg-violet-50 dark:bg-violet-900/20 rounded-lg border border-violet-200 dark:border-violet-800">
                  <p className="text-xs text-zinc-600 dark:text-zinc-400 mb-1">Sênior</p>
                  <p className="font-bold text-zinc-900 dark:text-white text-sm">Arquitetura</p>
                </div>
              </div>
            </div>
          </div>
