      ...
      <main className="relative z-10 flex items-center justify-center min-h-screen p-4 md:p-8">
        <div className="w-full max-w-4xl">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-zinc-600 dark:text-zinc-400">Jornada de Carreira</p>
          </div>

          {/* Current Position Card */}
          <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-8 shadow-lg hover:shadow-xl transition-shadow">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-6">
              ...
              <div className="mt-4 md:mt-0 px-4 py-2 bg-blue-100 dark:bg-blue-900/30 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-6 border-t border-zinc-200 dark:border-zinc-800">
              <div>
                <p className="text-zinc-600 dark:text-zinc-400 text-sm mb-1">Período</p>
                <p className="text-zinc-900 dark:text-white font-semibold">
                  Outubro 2025 - Presente
                </p>
              </div>
              <div>
                <p className="text-zinc-600 dark:text-zinc-400 text-sm mb-1">Duração</p>
                <InternshipTimer />
              </div>
              <div>
                <p className="text-zinc-600 dark:text-zinc-400 text-sm mb-1">Foco Atual</p>
                <p className="text-zinc-900 dark:text-white font-semibold">
                  Frontend
                </p>
              </div>
